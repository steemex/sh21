...
START_TEST(memchr_test) {
  ...
  ck_assert_ptr_eq(s21_memchr(s1, 's', 26), memchr(s1, 's', 26));
  ck_assert_ptr_eq(s21_memchr(s1, 'u', 26), memchr(s1, 'u', 26));
  ck_assert_ptr_eq(s21_memchr(s1, 'u', 26), memchr(s1, 'u', 26));
}
END_TEST
...
START_TEST(memcmp_test) {
  ...
  ck_assert_msg(s21_memcmp(s1, s2, 256) == memcmp(s1, s2, 37),
                "1st memcmp test failed.");
  ck_assert_msg(s21_memcmp(s1, s2, 2) == memcmp(s1, s2, 2),
                "2nd memcmp test failed.");
  ck_assert_msg(s21_memcmp(s1, s2, 123) == memcmp(s1, s2, 37),
...
START_TEST(sscanf_test_all) {
  int d1 = 0, d2 = 0, i1 = 0, i2 = 0, r1 = 0, r2 = 0;
